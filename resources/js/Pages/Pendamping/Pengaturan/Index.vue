...
<template>
    <PendampingLayout>
        ...
        <div class="space-y-6 max-w-xl">
            <div>
                <h2 class="text-xl sm:text-2xl font-extrabold text-slate-900 tracking-tight">Pengaturan</h2>
                <p class="text-xs sm:text-sm text-slate-500 font-medium">Ubah nama akun dan preferensi profile.</p>
            </div>
