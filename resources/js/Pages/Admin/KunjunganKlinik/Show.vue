...
<template> 
    ...
    <AdminLayout :breadcrumbs="breadcrumbs"> 
        ...
        <div class="min-h-screen bg-pink-50/40"> 
            ...
            <div class="border-b border-pink-100 bg-white"> 
                    ...
                    > 
                        ...
                        <div class="flex items-center gap-3"> 
                            ...
                            <Link 
                                ...
                                class="inline-flex h-9 w-9 shrink-0 items-center justify-center rounded-xl border border-pink-100 bg-white text-slate-500 transition hover:bg-pink-50 hover:text-pink-700" 
                                title="Kembali" 
                            > 
                            ...
                            <div> 
                                ...
                                <div 
                                    class="mb-1 flex items-center gap-2 text-xs font-semibold uppercase tracking-wider text-pink-600" 
                                > 
            ...
            <main class="mx-auto max-w-7xl px-6 py-7"> 
                ...
                <section 
                    class="relative mb-6 overflow-hidden rounded-2xl border border-pink-100 bg-white shadow-sm" 
                > 
 
                    <!-- ACCENT --> 
 
                    <div 
                        class="absolute left-0 top-0 h-full w-1 bg-pink-600" 
                    ></div> 
                    ...
                    <div class="p-6 md:p-7"> 
                        ...
                        > 
                            ...
                            <div class="flex items-center gap-4"> 
                                ...
                                <div 
                                    class="flex h-16 w-16 shrink-0 items-center justify-center rounded-2xl bg-pink-600 text-xl font-bold text-white shadow-sm" 
                                > 
                                    {{ initialNama() }} 
                                </div> 
                            ...
                            <div 
                                class="flex items-center gap-3 rounded-xl bg-pink-50 px-4 py-3" 
                            > 
 
                                <div 
                                    class="flex h-10 w-10 items-center justify-center rounded-lg bg-white text-pink-600 shadow-sm" 
                                > 
                        ...
                        <div 
                            class="mt-6 grid grid-cols-1 border-t border-pink-100 pt-5 sm:grid-cols-3" 
                        > 
                            ...
                            <div 
                                class="border-b border-pink-100 pb-4 sm:border-b-0 sm:border-r sm:pr-5" 
                            > 
                            ...
                            <div 
                                class="border-b border-pink-100 py-4 sm:border-b-0 sm:border-r sm:px-5 sm:py-0" 
                            > 
                ...
                <div class="grid grid-cols-1 gap-6 lg:grid-cols-3"> 
                    ...
                    <section 
                        class="overflow-hidden rounded-2xl border border-pink-100 bg-white shadow-sm lg:col-span-2" 
                    > 
                        ...
                        <div class="divide-y divide-pink-100"> 
                            ...
                            > 
                                ...
                                <p 
                                    class="text-sm font-semibold leading-6 text-pink-900" 
                                > 
                        ...
                        > 
                            ...
                            <div class="p-5"> 
                                ...
                                <div class="flex items-center gap-3"> 
                                    ...
                                    <div 
                                        class="flex h-12 w-12 items-center justify-center rounded-xl bg-pink-50 text-sm font-bold text-pink-600" 
                                    > 
