    ...
    <PetugasLayout>
        ...
        <div class="space-y-6 max-w-xl">
            <div class="flex items-center space-x-3">
                ...
                <div>
                    <h2 class="text-xl font-extrabold text-slate-900 tracking-tight">Tambah Obat</h2>
                    <p class="text-xs text-slate-500 font-medium">Tambah jenis obat ke inventaris UKS.</p>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-md border border-slate-100 p-6 md:p-8">
                <form @submit.prevent="submit" class="space-y-5">
                    <div class="space-y-1.5">
                        ...
                        <input type="text" v-model="form.name" required class="w-full border border-slate-300 rounded-xl px-4 py-2.5 text-sm" placeholder="Contoh: Paracetamol 500mg" />
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div class="space-y-1.5">
                            <label class="text-xs font-bold text-slate-700 uppercase tracking-wider">Stok Awal</label>
                        ...
                        <div class="space-y-1.5">
                            ...
                            <input type="text" v-model="form.unit" required class="w-full border border-slate-300 rounded-xl px-4 py-2.5 text-sm" placeholder="Contoh: Tablet / Botol" />
                        </div>
                    </div>
                    ...
                    <div class="flex justify-end space-x-3 pt-4 border-t border-slate-100">
                        ...
                        <button type="submit" class="px-5 py-2.5 bg-blue-600 hover:bg-blue-700 text-white text-xs font-bold rounded-xl transition shadow-md">Simpan</button>
                    </div>
                </form>
            </div>
        </div>
