        ...
        >
            ...
            >
                ...
                <div>
                    ...
                    >
                        Menampilkan {{ filteredObats.length }}
                        dari {{ totalObat }} obat.
                    </p>
                ...
                >
                    ...
                    >
                        ...
                        <Link
                            ...
                            class="inline-flex items-center justify-center gap-2 rounded-xl border border-blue-200 bg-blue-50 px-3 py-2.5 text-xs font-bold text-blue-700 transition hover:bg-blue-100"
                        >
