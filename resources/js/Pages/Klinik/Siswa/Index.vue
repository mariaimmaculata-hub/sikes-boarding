    ...
    <div class="space-y-6">
        ...
        >
            ...
            <div class="flex items-start gap-3">
                ...
                <div
                    class="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-amber-100"
                >
                ...
                >
                    ...
                    <div class="relative w-full sm:w-80">
                        ...
                        <input
                            ...
                            class="w-full rounded-xl border border-slate-200 bg-slate-50 py-2.5 pl-10 pr-10 text-sm text-slate-700 outline-none transition placeholder:text-slate-400 focus:border-blue-500 focus:bg-white focus:ring-2 focus:ring-blue-100"
                        />
                        ...
                        <button
                            ...
                            type="button"
                            @click="resetSearch"
                            class="absolute right-2 top-1/2 -translate-y-1/2 rounded-lg p-1 text-slate-400 transition hover:bg-slate-200 hover:text-slate-600"
                        >
                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            <span
                                class="shrink-0 rounded-lg bg-slate-100 px-2.5 py-1 text-[10px] font-bold text-slate-600"
                            >
                        ...
                        >
                            ...
                            <Link
                                ...
                                class="inline-flex items-center gap-1 rounded-lg px-3 py-2 text-xs font-semibold text-blue-600 transition hover:bg-blue-50"
                            >
